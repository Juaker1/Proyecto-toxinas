...
class DummyGraphPort:
    ...
    def build_graph(self, pdb_path: str, granularity: str, distance_threshold: float):
        self.called_with = (pdb_path, granularity, distance_threshold)
        return {'graph': True}
